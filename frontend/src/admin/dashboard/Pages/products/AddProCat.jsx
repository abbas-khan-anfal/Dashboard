...
const AddProCat = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try
        {
            ...
            const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/productcategory/add`,{c_name : category.toLowerCase()} ,{
                headers : {
            ...
            <div className="row justify-content-center">
                <div className="col-lg-7 col-md-8 col-sm-12 my-5">
                    <form action="" className='dashboardForm' onSubmit={submitHandler}>
                        <h4 className='h4_h'><button className='dashBackBtn' type='button' onClick={goBack}><i className="fa-solid fa-arrow-left"></i></button> Add Product Category</h4>
                        <div className="mb-3">
