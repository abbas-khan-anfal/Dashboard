...
const UpdatePostCat = () => {
    ...
    const fetchSingleCategory = async (cId) => {
        ...
        try
        {
            const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/postcategory/singlecategory/${cId}`, {
    ...
    const submitHandler = async (e) => {
        ...
        try
        {
            ...
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/postcategory/update`, updateData , {
                headers : {
                ...
                <div className="col-lg-7 col-md-8 col-sm-12 my-5">
                    {
                        ...
                        (
                            <form action="" className='dashboardForm' onSubmit={submitHandler}>
                                <h4 className='h4_h'><button className='dashBackBtn' type='button' onClick={goBack}><i className="fa-solid fa-arrow-left"></i></button> Update Post Category</h4>
                                <div className="mb-3">
