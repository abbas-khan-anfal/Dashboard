...
const PostCategories = () => {
    ...
    const fetchPostCategories = async (page) => {
        setLoading(true);
        try
        {
            const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/postcategory/fetch?page=${page}`, {
    ...
    useEffect(() => {
        fetchPostCategories(currentPage);
    }, [currentPage]);
    ...
    const deleteCategoryHandler = async (catId) => {
        ...
        try
        {
            const response = await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/postcategory/delete?id=${catId}`, {
                withCredentials : true
            });
        ...
        <div className="container">
            <div className="row boxShadow my-2">
                ...
                <div className="col-12 mb-3 d-flex justify-content-between">
                    <h4 className='h4_h'><button className='dashBackBtn' type='button' onClick={goBack}><i className="fa-solid fa-arrow-left"></i></button> Post Categories</h4>
                    <NavLink className="sm_btn" to='/admin/posts/addpostcategory'>Add New Category</NavLink>
                </div>
                                ...
                                (
                                    categories.map((category, index) => (
                                        <tr key={index}>
                                            ...
                                            <td><NavLink to={`/admin/posts/updatepostcategory/${category._id}`} className='editBtn'><i className="fa-solid fa-pen-to-square"></i></NavLink></td>
                                            <td>
